                                              ...
                                              juce::MidiBuffer& midiMessages)
{
    ...
    // midiMessages.clear();                                                                                   // [10]

    // if ((time +  buffer.getNumSamples()) >= noteDuration)                                                        // [11]
    // {
    //     auto offset = juce::jmax (0, juce::jmin ((int) (noteDuration - time),  buffer.getNumSamples() - 1));     // [12]
    ...
    // time = (time + buffer.getNumSamples()) % noteDuration;    
}
